...
class EIS(EChemProcedure):
    def __init__(self, data, freq_idx, real_idx, imag_idx, phase_shift = None) -> None:
        
        self.frequency = data[freq_idx]
        self.real_impedance = data[real_idx]
        self.imaginary_impedance = data[imag_idx]
...
# class EIS_A(plot, data): # plot and data of our defined classes maybe open a folder calls "util" and we can call it from there. There data will be assembled, new directories can be created, dataframe can be built.
